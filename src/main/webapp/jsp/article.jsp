...
<script type="text/javascript">
    $(function () {
        ...
        jQuery("#articleTable").jqGrid('navGrid', '#articlePage', {edit : false,add : false,del : true,deltext: "删除"},{
            closeAfterDel: true
        });
    });
    // 点击添加文章时触发事件
    ...
    //点击删除时触发事件
    function del(id){
        <%--location.href = "${pageContext.request.contextPath}/article/deleteArticle?id="+id;--%>
        $.ajax({
